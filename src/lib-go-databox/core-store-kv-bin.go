...
type BinaryKeyValue_0_2_0 interface {
	...
	// Get notifications of updated values
	RegisterDatasource(metadata types.DataSourceMetadata) error
}
...
func (kvc binaryKeyValueClient) RegisterDatasource(metadata types.DataSourceMetadata) error {
